...
function ( cat_1, a_1, b_1, alpha_1 )
    ...
    deduped_15_1 := Length( b_1 );
    deduped_14_1 := Length( a_1 );
    deduped_13_1 := Length( Source( alpha_1 ) );
    deduped_12_1 := deduped_15_1 ^ deduped_14_1;
    deduped_11_1 := [ 0 .. deduped_13_1 * deduped_14_1 - 1 ];
    hoisted_2_1 := deduped_15_1;
    hoisted_1_1 := deduped_12_1;
    hoisted_9_1 := List( [ 0 .. deduped_12_1 * deduped_14_1 - 1 ], function ( i_2 )
            return REM_INT( QUO_INT( i_2, hoisted_2_1 ^ QUO_INT( i_2, hoisted_1_1 ) ), hoisted_2_1 );
        end );
    hoisted_8_1 := Length( Range( alpha_1 ) );
    hoisted_6_1 := deduped_14_1;
    hoisted_3_1 := deduped_13_1;
    hoisted_7_1 := List( deduped_11_1, function ( logic_new_func_x_2 )
            return REM_INT( QUO_INT( logic_new_func_x_2, hoisted_3_1 ), hoisted_6_1 );
        end );
    hoisted_4_1 := AsList( alpha_1 );
    hoisted_5_1 := List( deduped_11_1, function ( logic_new_func_x_2 )
            return hoisted_4_1[1 + REM_INT( logic_new_func_x_2, hoisted_3_1 )];
        end );
    hoisted_10_1 := List( deduped_11_1, function ( logic_new_func_x_2 )
            local deduped_1_2;
            deduped_1_2 := 1 + logic_new_func_x_2;
            return hoisted_9_1[1 + (hoisted_5_1[deduped_1_2] + hoisted_7_1[deduped_1_2] * hoisted_8_1)];
        end );
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, b_1, AsList, List( [ 0 .. deduped_14_1 - 1 ], function ( i_2 )
...
function ( cat_1, alpha_1 )
    ...
    deduped_7_1 := [ 0 .. deduped_9_1 - 1 ];
    hoisted_6_1 := deduped_8_1;
    hoisted_1_1 := AsList( alpha_1 );
    hoisted_4_1 := List( deduped_7_1, function ( i_2 )
            return hoisted_1_1[1 + i_2];
        end );
    hoisted_3_1 := CAP_JIT_INCOMPLETE_LOGIC( [ 0 .. deduped_9_1 ^ deduped_9_1 - 1 ][1 + deduped_9_1 * GeometricSumDiff1( deduped_9_1, deduped_9_1 )] );
    hoisted_2_1 := deduped_9_1;
    hoisted_5_1 := List( deduped_7_1, function ( logic_new_func_x_2 )
            return hoisted_4_1[1 + REM_INT( QUO_INT( hoisted_3_1, hoisted_2_1 ^ logic_new_func_x_2 ), hoisted_2_1 )];
        end );
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, Length, 1 ), CreateCapCategoryObjectWithAttributes( cat_1, Length, deduped_8_1 ^ deduped_9_1 ), AsList, [ Sum( List( deduped_7_1, function ( k_2 )
                    return hoisted_5_1[(1 + k_2)] * hoisted_6_1 ^ k_2;
                end ) ) ] );
end
########
...
function ( cat_1, s_1, alpha_1, beta_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, AsList, List( [ 0 .. deduped_7_1 ^ deduped_8_1 - 1 ], function ( i_2 )
              ...
              hoisted_2_2 := List( hoisted_5_1, function ( logic_new_func_x_3 )
                      return hoisted_4_1[1 + hoisted_1_2[(1 + hoisted_3_1[(1 + logic_new_func_x_3)])]];
                  end );
...
function ( cat_1, l_1, m_1 )
    ...
    deduped_38_1 := Range( m_1 );
    deduped_37_1 := Length( Source( l_1 ) );
    ...
    hoisted_12_1 := List( deduped_27_1, function ( logic_new_func_x_2 )
            return hoisted_10_1[1 + hoisted_9_1[(1 + logic_new_func_x_2)]];
        end );
    ...
    hoisted_16_1 := List( deduped_27_1, function ( logic_new_func_x_2 )
            return hoisted_4_1[1 + hoisted_13_1[(1 + hoisted_9_1[(1 + logic_new_func_x_2)])]];
        end );
    hoisted_15_1 := List( deduped_26_1, function ( i_2 )
            return REM_INT( i_2, hoisted_11_1 );
        end );
    hoisted_14_1 := deduped_24_1;
    hoisted_17_1 := List( [ 0 .. Length( deduped_24_1 ) - 1 ], function ( logic_new_func_x_2 )
            return hoisted_16_1[1 + hoisted_15_1[(1 + hoisted_14_1[(1 + logic_new_func_x_2)])]];
        end );
    hoisted_18_1 := List( deduped_34_1, function ( x_2 )
            if x_2 in hoisted_17_1 then
                return 1;
            else
                return 0;
            fi;
    ...
    hoisted_5_1 := List( [ 0 .. Length( deduped_31_1 ) - 1 ], function ( logic_new_func_x_2 )
            return hoisted_4_1[1 + hoisted_3_1[(1 + hoisted_2_1[(1 + logic_new_func_x_2)])]];
        end );
    hoisted_6_1 := List( deduped_34_1, function ( x_2 )
            if x_2 in hoisted_5_1 then
                return 1;
            else
                return 0;
            fi;
    ...
    hoisted_21_1 := List( deduped_34_1, function ( logic_new_func_x_2 )
            local deduped_1_2;
            deduped_1_2 := 1 + logic_new_func_x_2;
            return hoisted_19_1[1 + (hoisted_6_1[deduped_1_2] + hoisted_18_1[deduped_1_2] * 2)];
        end );
    hoisted_20_1 := deduped_35_1;
    deduped_30_1 := Filtered( deduped_34_1, function ( x_2 )
            return hoisted_21_1[1 + REM_INT( x_2, hoisted_20_1 )] = 1;
        end );
    hoisted_23_1 := List( deduped_34_1, function ( i_2 )
            return REM_INT( i_2, hoisted_20_1 );
        end );
    hoisted_22_1 := deduped_30_1;
    deduped_25_1 := SSortedList( List( [ 0 .. Length( deduped_30_1 ) - 1 ], function ( logic_new_func_x_2 )
              return hoisted_23_1[1 + hoisted_23_1[(1 + hoisted_22_1[(1 + logic_new_func_x_2)])]];
          end ) );
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, Length, Length( deduped_25_1 ) ), deduped_38_1, AsList, deduped_25_1 );
end
########
