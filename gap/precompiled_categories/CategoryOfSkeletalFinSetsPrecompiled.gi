...
function ( cat_1, s_1, a_1, b_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, AsList, List( s_1, function ( i_2 )
...
function ( cat_1, a_1, b_1, alpha_1 )
    ...
    deduped_10_1 := Length( a_1 );
    deduped_9_1 := Length( b_1 );
    deduped_8_1 := deduped_9_1 ^ deduped_10_1;
    hoisted_2_1 := deduped_9_1;
    hoisted_1_1 := deduped_8_1;
    hoisted_7_1 := List( [ 0 .. deduped_8_1 * deduped_10_1 - 1 ], function ( i_2 )
            return REM_INT( QUO_INT( i_2, hoisted_2_1 ^ QUO_INT( i_2, hoisted_1_1 ) ), hoisted_2_1 );
        end );
    hoisted_6_1 := Length( Range( alpha_1 ) );
    hoisted_5_1 := deduped_10_1;
    hoisted_4_1 := AsList( alpha_1 );
    hoisted_3_1 := Length( Source( alpha_1 ) );
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, b_1, AsList, List( a_1, function ( i_2 )
              return hoisted_7_1[1 + (hoisted_4_1[1 + REM_INT( i_2, hoisted_3_1 )] + REM_INT( QUO_INT( i_2, hoisted_3_1 ), hoisted_5_1 ) * hoisted_6_1)];
          end ) );
end
########
...
function ( cat_1, alpha_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, Length, 1 ), CreateCapCategoryObjectWithAttributes( cat_1, Length, deduped_7_1 ^ deduped_8_1 ), AsList, ListWithIdenticalEntries( 1, Sum( List( deduped_6_1, function ( k_2 )
                  return hoisted_4_1[(1 + REM_INT( QUO_INT( hoisted_3_1, hoisted_2_1 ^ CAP_JIT_INCOMPLETE_LOGIC( hoisted_1_1[(1 + k_2)] ) ), hoisted_2_1 ))] * hoisted_5_1 ^ k_2;
              end ) ) ) );
end
########
...
function ( cat_1, alpha_1, Omega_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_2_1, Omega_1, AsList, List( deduped_2_1, function ( x_2 )
...
function ( cat_1, alpha_1, I_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_3_1, I_1, AsList, List( deduped_3_1, function ( i_2 )
...
function ( cat_1, alpha_1, beta_1 )
    ...
    hoisted_1_1 := AsList( alpha_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_3_1, Range( beta_1 ), AsList, List( deduped_3_1, function ( y_2 )
...
function ( cat_1, s_1, alpha_1, beta_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, AsList, List( [ 0 .. deduped_7_1 ^ deduped_8_1 - 1 ], function ( i_2 )
              ...
              return Sum( List( hoisted_6_1, function ( k_3 )
                        return hoisted_4_1[(1 + hoisted_1_2[(1 + hoisted_3_1[(1 + k_3)])])] * hoisted_5_1 ^ k_3;
                    end ) );
          end ) );
end
########
...
function ( cat_1, alpha_1, beta_1 )
    ...
    hoisted_2_1 := AsList( beta_1 );
    hoisted_1_1 := AsList( alpha_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_3_1, Source( beta_1 ), AsList, List( deduped_3_1, function ( x_2 )
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    hoisted_4_1 := List( [ 0 .. deduped_5_1 * deduped_7_1 - 1 ], function ( i_2 )
            return REM_INT( QUO_INT( i_2, hoisted_2_1 ^ QUO_INT( i_2, hoisted_1_1 ) ), hoisted_2_1 );
        end );
    hoisted_3_1 := deduped_7_1;
    return List( CreateCapCategoryObjectWithAttributes( cat_1, Length, deduped_5_1 ), function ( i_2 )
            return CreateCapCategoryMorphismWithAttributes( cat_1, arg2_1, arg3_1, AsList, List( arg2_1, function ( i_3 )
                      return hoisted_4_1[1 + (i_2 + REM_INT( i_3, hoisted_3_1 ) * hoisted_1_1)];
                  end ) );
        end );
end
########
...
function ( cat_1, alpha_1, beta_1 )
    ...
    hoisted_2_1 := AsList( beta_1 );
    hoisted_1_1 := AsList( alpha_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_3_1, Range( beta_1 ), AsList, List( deduped_3_1, function ( i_2 )
...
function ( cat_1, objects_1, k_1, P_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, objects_1[k_1], AsList, List( P_1, function ( i_2 )
...
function ( cat_1, l_1, m_1 )
    ...
    deduped_24_1 := Range( m_1 );
    deduped_23_1 := Length( Source( l_1 ) );
    deduped_22_1 := Length( Source( m_1 ) );
    deduped_21_1 := Length( deduped_24_1 );
    hoisted_2_1 := deduped_22_1;
    deduped_20_1 := Filtered( [ 0 .. deduped_22_1 * deduped_22_1 - 1 ], function ( x_2 )
            return REM_INT( x_2, hoisted_2_1 ) = REM_INT( QUO_INT( x_2, hoisted_2_1 ), hoisted_2_1 );
        end );
    hoisted_7_1 := AsList( l_1 );
    hoisted_6_1 := deduped_23_1;
    deduped_19_1 := Filtered( [ 0 .. deduped_22_1 * deduped_23_1 - 1 ], function ( x_2 )
            return REM_INT( x_2, hoisted_2_1 ) = hoisted_7_1[1 + REM_INT( QUO_INT( x_2, hoisted_2_1 ), hoisted_6_1 )];
        end );
    deduped_18_1 := Length( deduped_19_1 );
    hoisted_9_1 := deduped_19_1;
    hoisted_8_1 := deduped_18_1;
    deduped_16_1 := Filtered( [ 0 .. deduped_18_1 * deduped_23_1 - 1 ], function ( x_2 )
            return REM_INT( QUO_INT( hoisted_9_1[1 + REM_INT( x_2, hoisted_8_1 )], hoisted_2_1 ), hoisted_6_1 ) = REM_INT( QUO_INT( x_2, hoisted_8_1 ), hoisted_6_1 );
        end );
    hoisted_12_1 := List( CreateCapCategoryObjectWithAttributes( cat_1, Length, 1 ), function ( i_2 )
            local deduped_1_2;
            if i_2 = 0 then
                deduped_1_2 := 1;
            else
    ...
    hoisted_13_1 := Filtered( [ 0, 1, 2, 3 ], function ( x_2 )
            return function (  )
                      if (x_2 in hoisted_12_1) then
                          return 1;
                      else
                          return 0;
                      fi;
    ...
    hoisted_11_1 := List( CreateCapCategoryObjectWithAttributes( cat_1, Length, Length( deduped_16_1 ) ), function ( i_2 )
            return hoisted_4_1[1 + REM_INT( hoisted_9_1[(1 + REM_INT( hoisted_10_1[(1 + i_2)], hoisted_8_1 ))], hoisted_2_1 )];
        end );
    hoisted_3_1 := deduped_20_1;
    hoisted_5_1 := List( CreateCapCategoryObjectWithAttributes( cat_1, Length, Length( deduped_20_1 ) ), function ( i_2 )
            return hoisted_4_1[1 + REM_INT( hoisted_3_1[(1 + i_2)], hoisted_2_1 )];
        end );
    hoisted_1_1 := deduped_21_1;
    deduped_17_1 := Filtered( [ 0 .. deduped_21_1 - 1 ], function ( x_2 )
            local deduped_1_2;
            deduped_1_2 := REM_INT( x_2, hoisted_1_1 );
            return function (  )
                      if (function (  )
                                    if (deduped_1_2 in hoisted_5_1) then
                                        return 1;
                                    else
                                        return 0;
                                    fi;
                                    return;
                                      ...
                                      if (deduped_1_2 in hoisted_11_1) then
                                          return 1;
                                      else
                                          return 0;
                                      fi;
                                      return;
                                  end(  ) * 2 in hoisted_13_1) then
                          return 1;
                      else
                          return 0;
                      fi;
                      ...
                      if (REM_INT( QUO_INT( x_2, hoisted_1_1 ), 1 ) = 0) then
                          return 1;
                      else
                          return 0;
                      fi;
    ...
    deduped_15_1 := SSortedList( List( CreateCapCategoryObjectWithAttributes( cat_1, Length, Length( deduped_17_1 ) ), function ( i_2 )
              return REM_INT( REM_INT( hoisted_14_1[1 + i_2], hoisted_1_1 ), hoisted_1_1 );
          end ) );
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, Length, Length( deduped_15_1 ) ), deduped_24_1, AsList, deduped_15_1 );
end
########
...
function ( cat_1, objects_1, T_1, tau_1, P_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, T_1, P_1, AsList, List( T_1, function ( i_2 )
              local hoisted_1_2;
              hoisted_1_2 := 1 + i_2;
...
function ( cat_1, Y_1, morphisms_1, T_1, tau_1, P_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, T_1, P_1, AsList, List( T_1, function ( x_2 )
