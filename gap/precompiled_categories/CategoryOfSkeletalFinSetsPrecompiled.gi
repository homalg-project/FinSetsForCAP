...
function ( cat_1, s_1, a_1, b_1, r_1 )
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, s_1, r_1, AsLazyArray, LazyArray( Length( s_1 ), function ( i_2 )
...
function ( cat_1, a_1, b_1, r_1 )
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, a_1, r_1, AsLazyArray, LazyArray( deduped_4_1, function ( i_2 )
...
function ( cat_1, a_1, b_1, s_1 )
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, s_1, b_1, AsLazyArray, LazyArray( deduped_3_1 * deduped_5_1, function ( i_2 )
...
function ( cat_1, a_1, b_1, alpha_1 )
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, a_1, b_1, AsLazyArray, LazyArray( deduped_18_1, function ( i_2 )
...
function ( cat_1, alpha_1 )
    ...
    hoisted_10_1 := LazyArray( deduped_12_1 ^ deduped_12_1, function ( i_2 )
            ...
            return Sum( hoisted_6_1, function ( k_3 )
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
             ...
             ), cat_1, Length, deduped_11_1 ^ deduped_12_1 ), AsLazyArray, LazyArray( 1, function ( i_2 )
...
function ( cat_1, a_1, r_1 )
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, a_1, a_1, AsLazyArray, LazyStandardInterval( Length( a_1 ) ) );
end
########
...
function ( cat_1, alpha_1, Omega_1 )
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, deduped_2_1, Omega_1, AsLazyArray, LazyArray( Length( deduped_2_1 ), function ( y_2 )
              if y_2 in hoisted_1_1 then
                  return 1;
              else
                  return 0;
              fi;
...
function ( cat_1, alpha_1, I_1 )
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, deduped_3_1, I_1, AsLazyArray, LazyArray( Length( deduped_3_1 ), function ( l_2 )
...
function ( cat_1, alpha_1, beta_1 )
    ...
    hoisted_1_1 := AsLazyArray( alpha_1 );
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, deduped_3_1, Range( beta_1 ), AsLazyArray, LazyArray( Length( deduped_3_1 ), function ( y_2 )
...
function ( cat_1, arg2_1 )
    return ObjectifyObjectForCAPWithAttributes( rec(
           ), cat_1, Length, Sum( arg2_1, Length ) );
end
########
...
function ( cat_1, arg2_1 )
    return ObjectifyObjectForCAPWithAttributes( rec(
           ), cat_1, Length, Product( List( arg2_1, Length ) ) );
end
########
...
function ( cat_1, morphisms_1, P_1 )
    local hoisted_1_1, hoisted_2_1, deduped_3_1;
    deduped_3_1 := List( morphisms_1, AsLazyArray );
    hoisted_2_1 := deduped_3_1{[ 2 .. Length( morphisms_1 ) ]};
    hoisted_1_1 := deduped_3_1[1];
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, P_1, List( morphisms_1, Source )[1], AsLazyArray, LazyArrayFromList( Filtered( [ 0 .. List( morphisms_1, function ( logic_new_func_x_2 )
                          return Length( AsLazyArray( logic_new_func_x_2 ) );
...
function ( cat_1, arg2_1 )
    local hoisted_1_1, hoisted_2_1, deduped_3_1;
    deduped_3_1 := List( arg2_1, AsLazyArray );
    hoisted_2_1 := deduped_3_1{[ 2 .. Length( arg2_1 ) ]};
    hoisted_1_1 := deduped_3_1[1];
    return ObjectifyObjectForCAPWithAttributes( rec(
           ), cat_1, Length, Length( Filtered( [ 0 .. List( arg2_1, function ( logic_new_func_x_2 )
                          return Length( AsLazyArray( logic_new_func_x_2 ) );
                      end )[1] - 1 ], function ( x_2 )
                local hoisted_1_2;
                hoisted_1_2 := hoisted_1_1[x_2];
...
function ( cat_1, s_1, alpha_1, beta_1, r_1 )
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, s_1, r_1, AsLazyArray, LazyArray( deduped_8_1 ^ deduped_9_1, function ( i_2 )
              local hoisted_1_2, hoisted_2_2, hoisted_3_2;
...
function ( cat_1, alpha_1, I_1 )
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, I_1, Range( alpha_1 ), AsLazyArray, LazyArrayFromList( SSortedList( AsLazyArray( alpha_1 ) ) ) );
end
########
...
function ( cat_1, arg2_1 )
    return ObjectifyObjectForCAPWithAttributes( rec(
           ), cat_1, Length, Length( SSortedList( AsLazyArray( arg2_1 ) ) ) );
end
########
...
function ( cat_1, objects_1, k_1, P_1 )
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, objects_1[k_1], P_1, AsLazyArray, LazyInterval( List( objects_1, Length )[k_1], Sum( objects_1{[ 1 .. k_1 - 1 ]}, Length ) ) );
end
########
...
function ( cat_1, alpha_1, beta_1 )
    ...
    hoisted_1_1 := AsLazyArray( alpha_1 );
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, deduped_3_1, Source( beta_1 ), AsLazyArray, LazyArray( Length( deduped_3_1 ), function ( x_2 )
...
function ( cat_1, A_1, I_1 )
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, A_1, I_1, AsLazyArray, LazyStandardInterval( Length( A_1 ) ) );
end
########
...
function ( cat_1, arg2_1, arg3_1, arg4_1 )
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, arg2_1, arg4_1, AsLazyArray, arg3_1 );
end
########
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    return List( [ 0 .. deduped_8_1 - 1 ], function ( i_2 )
            ...
            return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
                   ), cat_1, arg2_1, arg3_1, AsLazyArray, LazyArray( hoisted_3_1, function ( i_3 )
...
function ( cat_1, alpha_1, beta_1 )
    ...
    hoisted_1_1 := AsLazyArray( alpha_1 );
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, deduped_3_1, Range( beta_1 ), AsLazyArray, LazyArray( Length( deduped_3_1 ), function ( i_2 )
              return hoisted_2_1[hoisted_1_1[i_2]];
          end ) );
end
########
...
function ( cat_1, objects_1, k_1, P_1 )
    ...
    hoisted_1_1 := Product( List( objects_1, Length ){[ 1 .. k_1 - 1 ]} );
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, P_1, deduped_3_1, AsLazyArray, LazyArray( Length( P_1 ), function ( i_2 )
...
function ( cat_1, morphisms_1, P_1 )
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, deduped_2_1, P_1, AsLazyArray, LazyArray( Length( deduped_2_1 ), function ( x_2 )
...
function ( cat_1, morphisms_1, T_1, tau_1, P_1 )
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, P_1, Range( tau_1 ), AsLazyArray, LazyArrayFromList( List( SKELETAL_FIN_SETS_ExplicitCoequalizer( morphisms_1 ), function ( x_2 )
                return tau_1( x_2[1] );
            end ) ) );
end
########
...
function ( cat_1, objects_1, T_1, tau_1, P_1 )
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, P_1, T_1, AsLazyArray, Concatenation( List( tau_1, AsLazyArray ) ) );
end
########
...
function ( cat_1, T_1, P_1 )
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, P_1, T_1, AsLazyArray, LazyStandardInterval( 0 ) );
end
########
...
function ( cat_1, objects_1, T_1, tau_1, P_1 )
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, T_1, P_1, AsLazyArray, LazyArray( Length( T_1 ), function ( i_2 )
...
function ( cat_1, morphisms_1, T_1, tau_1, P_1 )
    local hoisted_1_1, hoisted_2_1, hoisted_3_1, hoisted_4_1, deduped_5_1;
    deduped_5_1 := AsLazyArray( morphisms_1[1] );
    hoisted_2_1 := List( morphisms_1, AsLazyArray ){[ 2 .. Length( morphisms_1 ) ]};
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, T_1, P_1, AsLazyArray, LazyArray( Length( T_1 ), function ( x_2 )
...
function ( cat_1, T_1, P_1 )
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, T_1, P_1, AsLazyArray, LazyConstantArray( Length( T_1 ), 0 ) );
end
########
