...
function ( cat_1, arg2_1 )
    ...
    return ObjectifyObjectForCAPWithAttributes( rec(
           ), cat_1, Length, Length( Filtered( [ 1 .. Length( Source( deduped_3_1 ) ) ], function ( x_2 )
                local hoisted_1_2;
                hoisted_1_2 := hoisted_1_1( x_2 );
                return ForAll( hoisted_2_1, function ( fj_3 )
                        return hoisted_1_2 = fj_3( x_2 );
...
function ( cat_1, s_1, alpha_1, beta_1, r_1 )
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
              ...
              local hoisted_1_2;
              hoisted_1_2 := List( hoisted_4_1, function ( i_3 )
                      return logic_new_func_x_2[hoisted_3_1[i_3]];
                  end );
              return Position( hoisted_6_1, ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
                       ), cat_1, hoisted_1_1, hoisted_2_1, AsList, List( hoisted_4_1, function ( i_3 )
                          return hoisted_5_1[hoisted_1_2[i_3]];
                      end ) ) );
          end ) );
end
########
...
function ( cat_1, objects_1, k_1, P_1 )
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
           ), cat_1, deduped_2_1, P_1, AsList, List( [ 1 .. Length( deduped_2_1 ) ], function ( x_2 )
