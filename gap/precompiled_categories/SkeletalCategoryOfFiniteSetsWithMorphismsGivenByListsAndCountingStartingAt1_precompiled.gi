...
# Implementations
#
BindGlobal( "ADD_FUNCTIONS_FOR_SkeletalCategoryOfFiniteSetsWithMorphismsGivenByListsAndCountingStartingAt1_precompiled", function ( cat )
...
function ( cat_1, s_1, a_1, b_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, AsList, List( [ 0 .. deduped_4_1 - 1 ], function ( i_2 )
              ...
              return 1 + (CAP_JIT_INCOMPLETE_LOGIC( QuoIntWithDomain( deduped_1_2, deduped_1_1, deduped_4_1 ) ) + CAP_JIT_INCOMPLETE_LOGIC( RemIntWithDomain( deduped_1_2, deduped_1_1, deduped_4_1 ) ) * hoisted_3_1);
          end ) );
end
########
...
function ( cat_1, s_1, a_1, b_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, AsList, List( deduped_6_1, function ( i_2 )
              local deduped_1_2;
              deduped_1_2 := 1 + i_2;
              return 1 + (hoisted_3_1[deduped_1_2] + hoisted_4_1[deduped_1_2] * hoisted_5_1);
          end ) );
end
########
...
function ( cat_1, a_1, b_1, alpha_1 )
    ...
    hoisted_3_1 := Cardinality( b_1 );
    hoisted_1_1 := -1 + AsList( alpha_1 )[1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, b_1, AsList, List( [ 0 .. deduped_4_1 - 1 ], function ( i_2 )
              return 1 + DigitInPositionalNotation( hoisted_1_1, i_2, deduped_4_1, hoisted_3_1 );
          end ) );
end
########
...
function ( cat_1, alpha_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, Cardinality, BigInt( 1 ) ), CreateCapCategoryObjectWithAttributes( cat_1, Cardinality, deduped_3_1 ^ deduped_4_1 ), AsList, [ 1 + Sum( List( [ 0 .. deduped_4_1 - 1 ], function ( k_2 )
                      return (-1 + hoisted_1_1[1 + k_2]) * deduped_3_1 ^ k_2;
                  end ) ) ] );
end
########
...
function ( cat_1, a_1, b_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, b_1, r_1, AsList, List( [ 0 .. deduped_4_1 - 1 ], function ( i_2 )
              return 1 + (i_2 * hoisted_1_1 + hoisted_2_1);
          end ) );
end
########
...
function ( cat_1, a_1, b_1, s_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, b_1, AsList, List( [ 0 .. deduped_5_1 - 1 ], function ( f_i_2 )
              return 1 + DigitInPositionalNotation( RemIntWithDomain( f_i_2, deduped_1_1, deduped_5_1 ), QuoIntWithDomain( f_i_2, deduped_1_1, deduped_5_1 ), deduped_7_1, deduped_6_1 );
          end ) );
end
########
...
function ( cat_1, a_1, r_1 )
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, r_1, AsList, [ 1 .. Cardinality( a_1 ) ] );
end
########
...
function ( cat_1, a_1, s_1 )
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, a_1, AsList, [ 1 .. Cardinality( a_1 ) ] );
end
########
...
function ( cat_1, a_1, b_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, b_1, r_1, AsList, List( [ 0 .. deduped_5_1 - 1 ], function ( i_2 )
              return 1 + (hoisted_3_1 + deduped_6_1 * i_2 * hoisted_2_1);
          end ) );
end
########
...
function ( cat_1, a_1, b_1, s_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, b_1, AsList, List( [ 0 .. deduped_4_1 - 1 ], function ( i_2 )
              return 1 + DigitInPositionalNotation( QuoIntWithDomain( i_2, deduped_1_1, deduped_4_1 ), RemIntWithDomain( i_2, deduped_1_1, deduped_4_1 ), deduped_1_1, hoisted_3_1 );
          end ) );
end
########
...
function ( cat_1, alpha_1, Omega_1 )
    ...
    deduped_2_1 := Target( alpha_1 );
    hoisted_1_1 := AsList( alpha_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_2_1, Omega_1, AsList, List( [ 1 .. Cardinality( deduped_2_1 ) ], function ( x_2 )
              return 1 + BoolToBigInt( x_2 in hoisted_1_1 );
          end ) );
end
########
...
function ( cat_1, alpha_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_4_1, CreateCapCategoryObjectWithAttributes( cat_1, Cardinality, BigInt( Length( deduped_3_1 ) ) ), AsList, List( [ 0 .. Cardinality( deduped_4_1 ) - 1 ], function ( x_2 )
              return BigInt( SafePosition( deduped_3_1, deduped_5_1[1 + x_2] ) );
          end ) );
end
########
...
function ( cat_1, Y_1, morphisms_1 )
    return CreateCapCategoryObjectWithAttributes( cat_1, Cardinality, BigInt( Length( SKELETAL_FIN_SETS_ExplicitCoequalizer( Cardinality( Y_1 ), List( morphisms_1, function ( x_2 )
                    return List( AsList( x_2 ), function ( i_3 )
                            return -1 + i_3;
                        end );
                end ) ) ) ) );
end
...
function ( cat_1, alpha_1, beta_1 )
    ...
    deduped_1_1 := List( AsList( alpha_1 ), function ( i_2 )
            return -1 + i_2;
        end );
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_4_1, Range( beta_1 ), AsList, List( [ 0 .. Cardinality( deduped_4_1 ) - 1 ], function ( y_2 )
              return 1 + CAP_JIT_EXPR_CASE_WRAPPER( function (  )
                          if not y_2 in deduped_1_1 then
                              return hoisted_2_1;
                          else
                              return -1 + hoisted_3_1[SafePosition( deduped_1_1, y_2 )];
                          fi;
                          return;
                      end )(  );
          end ) );
...
function ( cat_1, a_1, b_1, f_1, i_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, b_1, i_1, AsList, List( [ 0 .. Cardinality( b_1 ) - 1 ], function ( i_2 )
              ...
              return 1 + Sum( List( hoisted_4_1, function ( k_3 )
                          return (-1 + hoisted_2_1[1 + k_3 + hoisted_1_2]) * hoisted_3_1 ^ k_3;
                      end ) );
          end ) );
end
########
...
function ( cat_1, Y_1, morphisms_1, P_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, Y_1, AsList, Filtered( [ 1 .. Cardinality( Y_1 ) ], function ( x_2 )
...
########
function ( cat_1, A_1 )
    return CreateCapCategoryMorphismWithAttributes( cat_1, A_1, A_1, AsList, [ 1 .. Cardinality( A_1 ) ] );
end
########
...
function ( cat_1, Y_1, morphisms_1 )
    ...
    hoisted_2_1 := [ 1 .. Length( morphisms_1 ) - 1 ];
    deduped_1_1 := List( morphisms_1, AsList );
    return CreateCapCategoryObjectWithAttributes( cat_1, Cardinality, BigInt( Length( Filtered( [ 1 .. Cardinality( Y_1 ) ], function ( x_2 )
                  return ForAll( hoisted_2_1, function ( j_3 )
                          return deduped_1_1[j_3][x_2] = deduped_1_1[j_3 + 1][x_2];
                      end );
              end ) ) ) );
...
function ( cat_1, arg2_1 )
    ...
    return List( [ 1 .. Cardinality( arg2_1 ) ], function ( i_2 )
...
function ( cat_1, s_1, alpha_1, beta_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, AsList, List( [ 0 .. deduped_8_1 ^ deduped_9_1 - 1 ], function ( i_2 )
              ...
              return 1 + Sum( List( hoisted_7_1, function ( k_3 )
                          return CAP_JIT_INCOMPLETE_LOGIC( -1 + hoisted_5_1[1 + hoisted_1_2[hoisted_4_1[1 + CAP_JIT_INCOMPLETE_LOGIC( k_3 )]]] ) * hoisted_6_1 ^ k_3;
                      end ) );
          end ) );
end
########
...
function ( cat_1, s_1, alpha_1, beta_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, AsList, List( [ 0 .. deduped_8_1 ^ deduped_9_1 - 1 ], function ( i_2 )
              ...
              hoisted_2_2 := List( deduped_6_1, function ( i_3 )
                      return -1 + hoisted_5_1[1 + hoisted_1_2[hoisted_4_1[1 + i_3]]];
                  end );
              return 1 + Sum( List( deduped_6_1, function ( k_3 )
...
function ( cat_1, a_1, c_1, g_1, s_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, c_1, AsList, List( [ 0 .. deduped_5_1 - 1 ], function ( i_2 )
              return 1 + DigitInPositionalNotation( -1 + hoisted_3_1[1 + QuoIntWithDomain( i_2, deduped_1_1, deduped_5_1 )], RemIntWithDomain( i_2, deduped_1_1, deduped_5_1 ), deduped_1_1, hoisted_4_1 );
          end ) );
end
########
...
function ( cat_1, objects_1, k_1, P_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, objects_1[k_1], P_1, AsList, List( [ deduped_1_1 .. deduped_1_1 + deduped_2_1[k_1] - 1 ], function ( i_2 )
              return 1 + i_2;
          end ) );
end
########
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    if Cardinality( Range( arg3_1 ) ) = 0 and not Cardinality( Range( arg2_1 ) ) = 0 then
        ...
        deduped_3_1 := List( AsList( arg2_1 ), function ( i_2 )
                return -1 + i_2;
            end );
        hoisted_2_1 := List( AsList( arg3_1 ), function ( i_2 )
                return -1 + i_2;
            end );
...
########
function ( cat_1, arg2_1 )
    return not false in SKELETAL_FIN_SETS_IsEpimorphism( List( AsList( arg2_1 ), function ( i_2 )
                   return -1 + i_2;
               end ), Cardinality( Range( arg2_1 ) ) );
end
########
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_4_1 := AsList( arg3_1 );
    deduped_3_1 := AsList( arg2_1 );
    deduped_2_1 := List( deduped_3_1, function ( i_2 )
            return -1 + i_2;
        end );
    hoisted_1_1 := List( deduped_4_1, function ( i_2 )
            return -1 + i_2;
        end );
...
########
function ( cat_1, arg2_1 )
    return SKELETAL_FIN_SETS_IsMonomorphism( List( AsList( arg2_1 ), function ( i_2 )
              return -1 + i_2;
          end ), Cardinality( Range( arg2_1 ) ) );
end
########
...
function ( cat_1, arg2_1 )
    ...
    return deduped_1_1 = 0 or not Cardinality( Source( arg2_1 ) ) = 0 and SKELETAL_FIN_SETS_IsMonomorphism( List( AsList( arg2_1 ), function ( i_2 )
                  return -1 + i_2;
              end ), deduped_1_1 );
end
########
...
function ( cat_1, alpha_1 )
    ...
    return ForAll( deduped_2_1, function ( a_2 )
            ...
            end ) and Cardinality( Source( alpha_1 ) ) = Length( deduped_3_1 ) and ForAll( deduped_2_1, function ( a_2 )
...
function ( cat_1, alpha_1, beta_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_3_1, Source( beta_1 ), AsList, List( [ 0 .. Cardinality( deduped_3_1 ) - 1 ], function ( x_2 )
              return BigInt( SafePosition( hoisted_2_1, hoisted_1_1[1 + x_2] ) );
          end ) );
end
########
...
function ( cat_1, A_1, I_1 )
    return CreateCapCategoryMorphismWithAttributes( cat_1, A_1, I_1, AsList, [ 1 .. Cardinality( A_1 ) ] );
end
########
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    return List( [ 0 .. deduped_4_1 ^ deduped_5_1 - 1 ], function ( i_2 )
            return CreateCapCategoryMorphismWithAttributes( cat_1, arg2_1, arg3_1, AsList, List( hoisted_3_1, function ( i_3 )
                      return 1 + DigitInPositionalNotation( i_2, i_3, deduped_5_1, deduped_4_1 );
                  end ) );
        end );
end
########
...
function ( cat_1, alpha_1, beta_1 )
    ...
    hoisted_2_1 := AsList( beta_1 );
    hoisted_1_1 := AsList( alpha_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_3_1, Range( beta_1 ), AsList, List( [ 1 .. Cardinality( deduped_3_1 ) ], function ( i_2 )
...
function ( cat_1, objects_1, k_1, P_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, objects_1[k_1], AsList, List( [ 0 .. deduped_7_1 - 1 ], function ( i_2 )
              return 1 + RemIntWithDomain( QuoIntWithDomain( i_2, deduped_5_1, deduped_7_1 ), deduped_6_1, hoisted_4_1 );
          end ) );
end
########
...
function ( cat_1, Y_1, morphisms_1, P_1 )
    ...
    hoisted_1_1 := SKELETAL_FIN_SETS_ExplicitCoequalizer( deduped_2_1, List( morphisms_1, function ( x_2 )
              return List( AsList( x_2 ), function ( i_3 )
                      return -1 + i_3;
                  end );
          end ) );
    return CreateCapCategoryMorphismWithAttributes( cat_1, Y_1, P_1, AsList, List( [ 0 .. deduped_2_1 - 1 ], function ( x_2 )
              return BigInt( SafeUniquePositionProperty( hoisted_1_1, function ( c_3 )
                        return x_2 in c_3;
                    end ) );
          end ) );
end
...
function ( cat_1, arg2_1 )
    local deduped_1_1;
    deduped_1_1 := Cardinality( arg2_1 );
    return CreateCapCategoryObjectWithAttributes( cat_1, Cardinality, CAP_JIT_EXPR_CASE_WRAPPER( function (  )
...
function ( cat_1 )
    local deduped_1_1;
    deduped_1_1 := BigInt( 2 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, Cardinality, BigInt( 4 ) ), CreateCapCategoryObjectWithAttributes( cat_1, Cardinality, deduped_1_1 ), AsList, [ deduped_1_1, BigInt( 1 ), deduped_1_1, deduped_1_1 ] );
end
########
...
function ( cat_1, Y_1, morphisms_1, T_1, tau_1, P_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, T_1, AsList, List( SKELETAL_FIN_SETS_ExplicitCoequalizer( Cardinality( Y_1 ), List( morphisms_1, function ( x_2 )
                  return List( AsList( x_2 ), function ( i_3 )
                          return -1 + i_3;
                      end );
              end ) ), function ( x_2 )
...
function ( cat_1, objects_1, T_1, tau_1, P_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, T_1, P_1, AsList, List( [ 0 .. Cardinality( T_1 ) - 1 ], function ( i_2 )
              local hoisted_1_2;
              hoisted_1_2 := 1 + i_2;
              return 1 + Sum( deduped_5_1, function ( j_3 )
...
function ( cat_1, Y_1, morphisms_1, T_1, tau_1, P_1 )
    ...
    hoisted_2_1 := [ 1 .. Length( morphisms_1 ) - 1 ];
    deduped_1_1 := List( morphisms_1, AsList );
    hoisted_4_1 := Filtered( [ 1 .. Cardinality( Y_1 ) ], function ( x_2 )
            return ForAll( hoisted_2_1, function ( j_3 )
                    return deduped_1_1[j_3][x_2] = deduped_1_1[j_3 + 1][x_2];
                end );
        end );
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, T_1, P_1, AsList, List( [ 0 .. Cardinality( T_1 ) - 1 ], function ( x_2 )
              return BigInt( SafePosition( hoisted_4_1, hoisted_3_1[1 + x_2] ) );
          end ) );
end
########
...
########
function ( cat_1, T_1, P_1 )
    return CreateCapCategoryMorphismWithAttributes( cat_1, T_1, P_1, AsList, ListWithIdenticalEntries( Cardinality( T_1 ), BigInt( 1 ) ) );
end
########
...
BindGlobal( "SkeletalCategoryOfFiniteSetsWithMorphismsGivenByListsAndCountingStartingAt1_precompiled", function ( sFinSets )
  local category_constructor, cat;
    ...
    category_constructor :=
        ...
        function ( sFinSets )
    return SkeletalCategoryOfFiniteSetsWithCountingStartingAt1( sFinSets );
end;
        
        
    
    cat := category_constructor( sFinSets : FinalizeCategory := false, no_precompiled_code := true );
    
    ADD_FUNCTIONS_FOR_SkeletalCategoryOfFiniteSetsWithMorphismsGivenByListsAndCountingStartingAt1_precompiled( cat );
